...
const TRANSLATIONS_EN = {
  ...
  "main.swimmerAssignOtherPeople": "Other people",
  ...
  "main.saveIncompleteTitle": "Are you sure you don't want to assign...",
  "main.saveIncompleteWho": "who is doing this workout",
  "main.saveIncompleteType": "type of workout",
  "main.saveIncompletePool": "pool size",
  "main.saveIncompleteDismiss": "Yes, my bad",
  ...
  "settings.viewportPreview": "Default view",
  "settings.viewportMobile": "Mobile",
  "settings.viewportDesktop": "Desktop",
  "settings.viewportAuto": "Auto",
  "settings.workoutDisplayFont": "Saved workout text",
  "settings.workoutFontSans": "Sans",
  "settings.workoutFontSerif": "Serif",
  "settings.workoutFontMono": "Monospace",
  "settings.workoutFontPacifico": "Pacifico",
  "settings.workoutFontAtkinson": "Atkinson",
  "settings.coachNewSwimDefault": "New swim workouts I add",
  "settings.coachNewSwimDefaultDraft": "Draft (hidden until you publish)",
  "settings.coachNewSwimDefaultPublished": "Published (visible to assignees)",
  ...
  "settings.teamManagementDesc": "Drag swimmers between sections to change groups; tap a name in a group to move them to Unassigned. Overrides the group they set in their profile.",
  "settings.teamUnassignedSwimmers": "Unassigned swimmers",
  "settings.teamUnassignedEmpty": "Everyone is assigned to a group.",
  "settings.teamGroupEmpty": "No swimmers in this group.",
  ...
  "feedback.total": "VOLUME",
  "feedback.yourFeedbackOptional": "Your feedback (optional)",
  "feedback.muscleIntensityOptional": "Muscle intensity (1–10, optional)",
  "feedback.cardioIntensityOptional": "Cardio intensity (1–10, optional)",
  ...
  "setup.optionalIntensityDesc": "Allows swimmers to add feedback without rating muscle/cardio intensity (1–10).",
...
const TRANSLATIONS_ES: Record<TranslationKey, string> = {
  ...
  "main.personalWorkoutsMenu": "Personales",
  "main.swimmerAssignOtherPeople": "Otras personas",
  ...
  "main.saveIncompleteTitle": "¿Seguro que no quieres asignar...?",
  "main.saveIncompleteWho": "quién hace este entrenamiento",
  "main.saveIncompleteType": "el tipo de entrenamiento",
  "main.saveIncompletePool": "el tamaño de la piscina",
  "main.saveIncompleteDismiss": "Sí, me equivoqué",
  ...
  "settings.viewportPreview": "Vista predeterminada",
  "settings.viewportMobile": "Móvil",
  "settings.viewportDesktop": "Escritorio",
  "settings.viewportAuto": "Automático",
  "settings.workoutDisplayFont": "Texto de entrenamientos guardados",
  "settings.workoutFontSans": "Sans",
  "settings.workoutFontSerif": "Serif",
  "settings.workoutFontMono": "Monoespacio",
  "settings.workoutFontPacifico": "Pacifico",
  "settings.workoutFontAtkinson": "Atkinson",
  "settings.coachNewSwimDefault": "Nuevos entrenamientos de natación que añado",
  "settings.coachNewSwimDefaultDraft": "Borrador (oculto hasta publicar)",
  "settings.coachNewSwimDefaultPublished": "Publicado (visible para los asignados)",
  ...
  "settings.teamManagementDesc": "Arrastra nadadores entre secciones para cambiar de grupo; pulsa un nombre en un grupo para pasarlo a Sin asignar. Sobrescribe el grupo de su perfil.",
  "settings.teamUnassignedSwimmers": "Nadadores sin asignar",
  "settings.teamUnassignedEmpty": "Todos tienen un grupo asignado.",
  "settings.teamGroupEmpty": "No hay nadadores en este grupo.",
  ...
  "feedback.total": "VOLUMEN",
  "feedback.yourFeedbackOptional": "Tu comentario (opcional)",
  "feedback.muscleIntensityOptional": "Intensidad muscular (1–10, opcional)",
  "feedback.cardioIntensityOptional": "Intensidad cardio (1–10, opcional)",
  ...
  "setup.optionalIntensityDesc": "Permite a los nadadores añadir comentarios sin valorar la intensidad muscular/cardio (1–10).",
